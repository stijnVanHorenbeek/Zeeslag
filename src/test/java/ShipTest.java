...
public class ShipTest {
    ...
    public void ship_should_throw_exception_given_a_zero_capacity(){
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Ship(new Coordinates(1,1), 0,0,0,0,0));
    }
    @Test
    public void ship_should_throw_exception_given_negative_speed(){
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Ship(new Coordinates(1,1), -1,0,0,0,0));
    }

    @Test
    public void ship_should_throw_exception_given_negative_agility(){
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Ship(new Coordinates(1,1), 1,-1,0,0,0));
    }
    ...
    public void ship_should_throw_exception_given_negative_vector(){
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Ship(new Coordinates(1,1), 1,0,0,0,-1));
    }
}
